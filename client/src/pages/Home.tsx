    ...
    <div className="min-h-screen bg-[#f6f3ed] text-stone-950">
      <header className="sticky top-0 z-20 border-b border-stone-200/80 bg-[#f6f3ed]/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-10">
          ...
          <span className="text-sm text-stone-500">Partner feeds managed securely</span>
        </div>
      </header>

      <main>
        <section className="mx-auto max-w-7xl px-5 pt-6 lg:px-10 lg:pt-8" aria-label="Brand Janra promotion">
          <div className="overflow-hidden rounded-[2rem] bg-stone-950 shadow-2xl ring-1 ring-stone-900/10">
        ...
        <section className="mx-auto max-w-7xl px-5 pb-24 lg:px-10"><div className="rounded-[1.75rem] border border-stone-200 bg-white px-7 py-8 text-center shadow-sm"><p className="text-xs font-bold uppercase tracking-[0.22em] text-stone-500">Catalog status</p><p className="mt-2 text-sm text-stone-600">Only products returned by a verified affiliate feed are shown. Partner configuration is managed securely in Vercel.</p></div></section>
      </main>
