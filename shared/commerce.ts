...
// 100% Verified Real Health & Beauty Store Catalog
export const HEALTH_BEAUTY_CATALOG: HealthBeautyItem[] = [
  ...
  {
    id: "kama-ayurveda-pure-rose-water",
    slug: "kama-ayurveda-pure-rose-water",
    name: "Pure Rose Water Face & Body Hydrating Mist (200ml)",
    brand: "Kama Ayurveda",
    ...
    accent: "from-rose-100 via-pink-50 to-amber-50",
    score: 97,
    keyBenefit: "Steam-distilled from Kannauj roses to tone, refresh, tighten pores, and balance skin pH.",
    skinType: "All skin types · 100% Pure & Natural",
    shipsWorldwide: false,
    shipsIndia: true,
    shippingNote: "Fast 2-3 Day Express Delivery via Ajio (Free over ₹799)",
    affiliateUrl: `https://extrape.com/c/ajio-kama-ayurveda-rosewater?aff=${AFFILIATE_CONFIG.extrapeId}`,
    tag: "Luxury Ayurvedic Pick",
    approvedForPublishing: true,
    createdAt: new Date().toISOString(),
  },
  {
    id: "forest-essentials-delicate-cleanser",
    slug: "forest-essentials-delicate-cleanser",
    name: "Delicate Facial Cleanser with Kashmiri Saffron & Neem (200ml)",
    ...
    accent: "from-amber-200 via-yellow-50 to-rose-50",
    score: 96,
    keyBenefit: "Purifies congested pores, replenishes moisture, and leaves skin with a natural glow using pure saffron extracts.",
    skinType: "Normal to Dry · Dull skin",
    shipsWorldwide: false,
    shipsIndia: true,
    shippingNote: "Fast 2-3 Day Express Delivery via Ajio (Free over ₹799)",
    affiliateUrl: `https://extrape.com/c/ajio-forest-essentials-cleanser?aff=${AFFILIATE_CONFIG.extrapeId}`,
    tag: "Ajio Best Seller",
    approvedForPublishing: true,
    createdAt: new Date().toISOString(),
  },
  {
    ...
    name: "Ceramide & Hyaluronic Barrier Repair Moisturizer (100g)",
    brand: "Dot & Key",
    category: "Skincare",
    type: "affiliate",
    priceUsd: 5.5,
  ...
  },
  {
    ...
    name: "15% Vitamin C Face Serum with Mandarin & Kakadu Plum (30ml)",
    brand: "Plum Goodness",
    category: "Clean Beauty",
    type: "affiliate",
    priceUsd: 7.0,
  ...
  },
  {
    ...
    name: "Niacinamide 10% + Zinc 1% Oil Control Serum (30ml)",
    brand: "The Ordinary",
    category: "Skincare",
    type: "affiliate",
    priceUsd: 6.5,
  ...
  },
  {
    ...
    name: "Hydrating Facial Cleanser with Ceramides & Hyaluronic Acid (473ml)",
    brand: "CeraVe",
    category: "Skincare",
    type: "affiliate",
    priceUsd: 14.99,
  ...
  },
  {
    ...
    name: "10% Vitamin C Face Glow & Brightening Serum (30ml)",
    brand: "Minimalist",
    category: "Skincare",
    type: "affiliate",
    priceUsd: 11.0,
